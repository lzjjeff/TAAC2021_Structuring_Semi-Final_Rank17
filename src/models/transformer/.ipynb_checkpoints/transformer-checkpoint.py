...
from src.models.transformer.position_embedding import SinusoidalPositionalEmbedding

from src.models.transformer.multihead_attention import MultiHeadAttention, MultiHeadAttentionFromPretrained
...
class CrossEncoderLayer(nn.Module):
    ...
    def forward(self, src_inputs, tgt_inputs, cross_attn_mask, cross_attn_weights=None):
        residual = tgt_inputs
        tgt_inputs = self.layer_norm_before(tgt_inputs)
        src_inputs = self.layer_norm_before(src_inputs)
